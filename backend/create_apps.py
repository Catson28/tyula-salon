...
apps_names = ['product', 'category', 'subcategory', 'service', 'payment', 'professional', 'employee', 'invoice', 'sale', 'image', 'customer', 'authentication', 'users']  # Lista de nomes de aplicativos
