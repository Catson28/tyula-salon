...
const FormImgUploadProduct: React.FC<Props> = ({ id }) => {
          ...
          <form>
            ...
            <div className="form-group">
              <button
                ...
                disabled={!currentImage || !productId || uploadSuccess}
                onClick={upload}
              >
                Upload
              </button>
...
export default FormImgUploadProduct;
